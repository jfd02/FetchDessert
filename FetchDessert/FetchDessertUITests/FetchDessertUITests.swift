...
final class FetchDessertUITests: XCTestCase {
    ...
    func testCollectionViewExists() throws {
        ...
        let cell = XCUIApplication().collectionViews.cells.otherElements.containing(.staticText, identifier:"Apam balik").element.waitForExistence(timeout: 10)
        XCTAssertTrue(cell)
    ...
    func testSearch() throws {
        ...
        XCUIApplication().collectionViews.cells.otherElements.containing(.staticText, identifier:"Apam balik").element.tap()
    }
}
